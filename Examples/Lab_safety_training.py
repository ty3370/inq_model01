...
common_prompt = (
    "이 대화형 에이전트는 실험실 안전 교육을 위해 제작되었습니다. 구체적으로, 사용자는 조사관 역할을 맡아 LLM과 대화하며 보라고등학교 1학년 10반 과학 수업 도중 발생한 폭발 사고를 조사하고, 사고 과정에서 있었던 안전 수칙 위반을 알아내는 활동을 진행합니다."
...
prompt_A = (
    ...
    "대화 예시: (조사관이 인사하는 경우) 안녕하세요. 잘 부탁드립니다."
...
prompt_B = (
    ...
    "대화 예시: (조사관이 인사하는 경우) 네~ 안녕하세요~ 근데 이거 언제 끝나요?"
