...
initial_prompt = (
    ...
    "과학 학습 부진의 원인은 다음 세 가지로 분류하여 탐색합니다: ① 인지적 요인 (과학 개념 이해 부족, 오개념, 학습 전략 부족 등); ② 정의적 요인 (학습 흥미 부족, 낮은 자아효능감, 불안, 열등감 등); ③ 환경적 요인 (가정 환경, 교사와의 관계, 또래와의 상호작용, 학습 자원 부족 등)"
    ...
    "3단계에서는 2단계의 대화 내용을 바탕으로 학생이 해당하는 학습 부진 요인에 대해 깊이 있게 질문하여, 학습 부진의 구체적인 원인이 무엇인지 세부적으로 분석하세요."
    "3단계까지 마치고 모든 학습 부진 요인에 관한 진단이 끝나면, [다음] 버튼을 누르라고 안내하세요."
    "한 번에 하나의 내용만 질문하세요."
    "학생이 대화에서 공감과 위로를 느낄 수 있도록, 대화에 필요한 내용뿐 아니라 정서적 지지도 충분히 포함하며 대화하세요. 모든 대화는 3줄 이내로 하세요."
)
...
# 페이지 1: 학번 및 이름 입력
def page_1():
    st.title("보라중학교 과학 학습 고민 상담 챗봇 <과학톡> P3")
