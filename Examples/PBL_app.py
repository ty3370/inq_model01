...
initial_prompt = (
    ...
    "학생이 파악해야 할 내용은 다음과 같습니다: 김현수의 사망 원인(저혈당, 저체온증), 이정민이 범인인 증거(저혈당을 일으킨 식단을 준비함, 저체온증을 일으키기 위해 작은 절단기를 가져와 난방 시스템을 고장냄). 이 정보를 모두 파악했다면, '멋진 추론입니다, 조사관님. 이제 조사 보고서를 작성해주세요'라고 말해주세요."
